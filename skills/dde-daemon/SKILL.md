...
详见 [org.deepin.dde.Accounts1.md](references/dbus/org.deepin.dde.Accounts1.md)
...
详见 [org.deepin.dde.ClipboardManager1.md](references/dbus/org.deepin.dde.ClipboardManager1.md)

### 屏幕保护

提供屏幕保护管理能力。

详见 [org.freedesktop.ScreenSaver.md](references/dbus/org.freedesktop.ScreenSaver.md)
...
详见 [org.deepin.dde.BacklightHelper1.md](references/dbus/org.deepin.dde.BacklightHelper1.md)
...
详见 [org.deepin.dde.AirplaneMode1.md](references/dbus/org.deepin.dde.AirplaneMode1.md)
