...
| 处理主题、配色、图标、字体和控件风格 | [references/theme/index.md](references/theme/index.md)、[references/theme/chameleon-style.md](references/theme/chameleon-style.md)、[references/utilities/font-manager.md](references/utilities/font-manager.md) |
...
| 前缀 | 目录 | 覆盖范围 | 数量 |
|------|------|----------|------|
| W- | widgets/ | QWidget 控件 | 29 |
| Q- | declarative/ | QML 控件 | 12 |
| T- | theme/ | 主题系统 | 7 |
| C- | config/ | DConfig 配置 | 4 |
| U- | utilities/ | 工具类 | 6 |
| D- | debugging/ | 调试场景 | 5 |
| X- | custom-controls/ | 自定义控件 | 6 |
| P- | project-setup/ | 工程配置 | 1 |
| A- | architecture/ | 架构理解 | 4 |
| L- | platform/ | 平台抽象 | 3 |
